...
describe('/lib/reducer-helpers/addReducer', () => {
  const state = {
    foo: {bar: 'baz'},
  };
  const action = {
  ...
  testAddReducer('getter fn, template value', (x, {payload: {foo}}) => foo, 1, {
    ...state,
    test: 1,
  });

  testAddReducer('getter value, template fn', 1, (x, {payload: {foo}}) => foo, {
    ...state,
    '1': 'test',
  });
